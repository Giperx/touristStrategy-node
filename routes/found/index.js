...
router.get('/loacl-database', async ctx => {
    return false
    const citydata = fs.readFileSync('C:/Users/Administrator/Desktop/lvyou-node-v3/local.json', 'utf-8')
...
router.get('/country-database', async ctx => {
    return false
    const citydata = fs.readFileSync('C:/Users/Administrator/Desktop/lvyou-node-v3/city.json', 'utf-8')
    const res = JSON.parse(citydata)
